...
public class C1_WebTable {
 ...
 /*
    ...
    public void table(){
        ...
        System.out.println("tablodaki sutun sayisi = " + koalaResortPage.firstRowDatas.size());
        ...
        for (WebElement each: koalaResortPage.columnHeaders
        ) {
        ...
        System.out.println("Tablo body'sinde bulunan cell sayisi = " + koalaResortPage.allBodyDatas.size() );
    ...
    public void getRows(){
        ...
        //-----  //tbod//tr
        System.out.println("Tablodaki satir sayisi : " + koalaResortPage.rowLists.size());

        //                ○ Table body’sinde bulunan satirlari(rows) konsolda yazdırın.

        for (WebElement each: koalaResortPage.rowLists
        ) {
            System.out.println(each.getText());
        }

        //                ○ 4.satirdaki(row) elementleri konsolda yazdırın.
        System.out.println(koalaResortPage.rowLists.get(3).getText());
        ...
        // 7. satiri yazdiralim
        System.out.println("=================");
        koalaResortPage.printDesiredRow(7);
